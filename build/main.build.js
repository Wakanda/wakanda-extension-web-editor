...
/******/ 	var hotCurrentHash = "d61ddc1637763814a6c0"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcCore = __webpack_require__(/*! ./src/core */ 1);
	...
	__webpack_require__(/*! ./styles/common.css */ 57);
	__webpack_require__(/*! ./styles/editor.css */ 59);
	__webpack_require__(/*! ./styles/tree.css */ 61);IDE.Core = new _srcCore2["default"](["plugins", "qParams", "toolbar", "fileManager", "editor"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Core = (function () {
		function Core(coreModules) {
			...
			var _EventEmitter = __webpack_require__(/*! ../../lib/micro-events.js */ 2);
			...
			coreModules.forEach(function (moduleName) {
				...
				var module = __webpack_require__(/*! ./modules */ 4)("./" + moduleName + "/index.js");
		...
		_createClass(Core, [{
			...
			value: function load(pluginName) {
				...
				this.plugins[pluginName].code = __webpack_require__(/*! ../plugins */ 33)("./" + pluginName + "/index.js");
				this.plugins[pluginName].manifest = __webpack_require__(/*! ../plugins */ 48)("./" + pluginName + "/manifest.js");
			}
		}, {
			key: "activate",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./editor/index.js": 5,
		"./explorer/index.js": 12,
		"./fileManager/index.js": 18,
		"./plugins/index.js": 31,
		"./qParams/index.js": 51,
		"./tabManager/index.js": 53,
		"./toolbar/index.js": 55
	};
...
/* 5 */
/*!*****************************************!*\
  !*** ./src/src/modules/editor/index.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
			...
			switch (IDE.qParams.mode) {
				case "html":
					__webpack_require__.e/* nsure */(1, function (require) {
						var Editor = __webpack_require__(/*! ./EditorHTML.js */ 6);
				...
				case "css":
					__webpack_require__.e/* nsure */(2, function (require) {
						var Editor = __webpack_require__(/*! ./EditorCSS.js */ 10);
						IDE.editor = new Editor({ id: "editor", lib: ace });
						loaded();
					});
					break;
				case "javascript":
					__webpack_require__.e/* nsure */(3, function (require) {
						var Editor = __webpack_require__(/*! ./EditorJS.js */ 11);
						IDE.editor = new Editor({ id: "editor", lib: ace });
						loaded();
					});
					break;
...
/* 12 */
/*!*******************************************!*\
  !*** ./src/src/modules/explorer/index.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Module = {
		activate: function activate(loaded) {
			var explorer = new _Tree2["default"]({
...
/* 13 */
/*!******************************************!*\
  !*** ./src/src/modules/explorer/Tree.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Tree = (function () {
		...
		_createClass(Tree, [{
			...
			value: function render() {
				...
				var jstree = __webpack_require__(/*! ../../../../lib/jstree/jstree.js */ 14);
				var $ = __webpack_require__(/*! ../../../../lib/jquery-2.1.3.min.js */ 15);
			...
			value: function hookEvents() {
				...
				var that = this;
				var interact = __webpack_require__(/*! ../../../../lib/interact-1.2.4.min.js */ 17);
			...
			value: function navigateToPath(currentPath, arrNext) {
				...
				this.navigateToNode(currentPath, function () {
					if (next.length) {
						_this3.navigateToPath((currentPath + "/" + next).replace(/\/\//g, '/'), arrNext);
					} else {
						_this3.selectNode(currentPath);
					}
				});
			}
		}, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	_node=document.createElement('LI'),_temp1,_temp2;_node.setAttribute('role','treeitem');_temp1 = document.createElement('I');_temp1.className = 'jstree-icon jstree-ocl';_temp1.setAttribute('role','presentation');_node.appendChild(_temp1);_temp1 = document.createElement('A');_temp1.className = 'jstree-anchor';_temp1.setAttribute('href','#');_temp1.setAttribute('tabindex','-1');_temp2 = document.createElement('I');_temp2.className = 'jstree-icon jstree-themeicon';_temp2.setAttribute('role','presentation');_temp1.appendChild(_temp2);_node.appendChild(_temp1);_temp1 = _temp2 = null; /**
		 ...
		 */$.jstree = { /**
			 ...
			 * @name $.jstree.plugins
			 */plugins:{},path:src && src.indexOf('/') !== -1?src.replace(/\/[^\/]+$/,''):'',idregex:/[\\:&!^|()\[\]<>@*'+~#";.,=\- \/${}%?`]/g}; /**
	...
	}).on("click.jstree",".jstree-ocl",$.proxy(function(e){this.toggle_node(e.target);},this)).on("dblclick.jstree",".jstree-anchor",$.proxy(function(e){if(this.settings.core.dblclick_toggle){this.toggle_node(e.target);}},this)).on("click.jstree",".jstree-anchor",$.proxy(function(e){e.preventDefault();if(e.currentTarget !== document.activeElement){$(e.currentTarget).focus();}this.activate_node(e.currentTarget,e);},this)).on('keydown.jstree','.jstree-anchor',$.proxy(function(e){if(e.target.tagName === "INPUT"){return true;}if(e.which !== 32 && e.which !== 13 && (e.shiftKey || e.ctrlKey || e.altKey || e.metaKey)){return true;}var o=null;if(this._data.core.rtl){if(e.which === 37){e.which = 39;}else if(e.which === 39){e.which = 37;}}switch(e.which){case 32: // aria defines space only with Ctrl
	...
	e.preventDefault();if(this.is_open(e.currentTarget)){this.close_node(e.currentTarget);}else {o = this.get_parent(e.currentTarget);if(o && o.id !== '#'){this.get_node(o,true).children('.jstree-anchor').focus();}}break;case 38: // up
	...
	e.preventDefault();this.element.find('.jstree-anchor').filter(':visible').last().focus();break; /*
								...
								default:
									// console.log(e.which);
									break;
								*/}},this)).on("load_node.jstree",$.proxy(function(e,data){if(data.status){if(data.node.id === '#' && !this._data.core.loaded){this._data.core.loaded = true;if(this._firstChild(this.get_container_ul()[0])){this.element.attr('aria-activedescendant',this._firstChild(this.get_container_ul()[0]).id);} /**
	...
	.on('keypress.jstree',$.proxy(function(e){if(e.target.tagName === "INPUT"){return true;}if(tout){clearTimeout(tout);}tout = setTimeout(function(){word = '';},500);var chr=String.fromCharCode(e.which).toLowerCase(),col=this.element.find('.jstree-anchor').filter(':visible'),ind=col.index(document.activeElement) || 0,end=false;word += chr; // match for whole word from current node down (including the current node)
	...
	if(new RegExp('^' + chr + '+$').test(word)){ // search for the next node starting with that letter
	...
	.on("init.jstree",$.proxy(function(){var s=this.settings.core.themes;this._data.core.themes.dots = s.dots;this._data.core.themes.stripes = s.stripes;this._data.core.themes.icons = s.icons;this.set_theme(s.name || "default",s.url);this.set_theme_variant(s.variant);},this)).on("loading.jstree",$.proxy(function(){this[this._data.core.themes.dots?"show_dots":"hide_dots"]();this[this._data.core.themes.icons?"show_icons":"hide_icons"]();this[this._data.core.themes.stripes?"show_stripes":"hide_stripes"]();},this)).on('blur.jstree','.jstree-anchor',$.proxy(function(e){this._data.core.focused = null;$(e.currentTarget).filter('.jstree-hovered').mouseleave();this.element.attr('tabindex','0');},this)).on('focus.jstree','.jstree-anchor',$.proxy(function(e){var tmp=this.get_node(e.currentTarget);if(tmp && tmp.id){this._data.core.focused = tmp.id;}this.element.find('.jstree-hovered').not(e.currentTarget).mouseleave();$(e.currentTarget).mouseenter();this.element.attr('tabindex','-1');},this)).on('focus.jstree',$.proxy(function(){if(+new Date() - was_click > 500 && !this._data.core.focused){was_click = 0;this.get_node(this.element.attr('aria-activedescendant'),true).find('> .jstree-anchor').focus();}},this)).on('mouseenter.jstree','.jstree-anchor',$.proxy(function(e){this.hover_node(e.currentTarget);},this)).on('mouseleave.jstree','.jstree-anchor',$.proxy(function(e){this.dehover_node(e.currentTarget);},this));}, /**
			 * part of the destroying of an instance. Used internally.
			 * @private
			 * @name unbind()
			 ...
			 * @return {mixed}
			 */get_path:function get_path(obj,glue,ids){obj = obj.parents?obj:this.get_node(obj);if(!obj || obj.id === '#' || !obj.parents){return false;}var i,j,p=[];p.push(ids?obj.id:obj.text);for(i = 0,j = obj.parents.length;i < j;i++) {p.push(ids?obj.parents[i]:this.get_text(obj.parents[i]));}p = p.reverse().slice(1);return glue?p.join(glue):p;}, /**
			 ...
			 * @param  {mixed} obj
			 * @return {String}
			 */get_parent:function get_parent(obj){obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}return obj.parent;}, /**
	...
	if(!s){if(obj.id === '#'){return this._append_html_data(obj,this._data.core.original_container_html.clone(true),function(status){callback.call(this,status);});}else {return callback.call(this,false);} // return callback.call(this, obj.id === '#' ? this._append_html_data(obj, this._data.core.original_container_html.clone(true)) : false);
	...
	}if(typeof s === 'string'){if(obj.id === '#'){return this._append_html_data(obj,$($.parseHTML(s)).filter(function(){return this.nodeType !== 3;}),function(status){callback.call(this,status);});}else {this._data.core.last_error = {'error':'nodata','plugin':'core','id':'core_06','reason':'Could not load node','data':JSON.stringify({'id':obj.id})};this.settings.core.error.call(this,this._data.core.last_error);return callback.call(this,false);} //return callback.call(this, (obj.id === "#" ? this._append_html_data(obj, $(s)) : false) );
			 ...
			 */_append_html_data:function _append_html_data(dom,data,cb){dom = this.get_node(dom);dom.children = [];dom.children_d = [];var dat=data.is('ul')?data.children():data,par=dom.id,chd=[],dpc=[],m=this._model.data,p=m[par],s=this._data.core.selected.length,tmp,i,j;dat.each($.proxy(function(i,v){tmp = this._parse_model_from_html($(v),par,p.parents.concat());if(tmp){chd.push(tmp);dpc.push(tmp);if(m[tmp].children_d.length){dpc = dpc.concat(m[tmp].children_d);}}},this));p.children = chd;p.children_d = dpc;for(i = 0,j = p.parents.length;i < j;i++) {m[p.parents[i]].children_d = m[p.parents[i]].children_d.concat(dpc);} /**
				 ...
				 */this.trigger('model',{"nodes":dpc,'parent':par});if(par !== '#'){this._node_changed(par);this.redraw();}else {this.get_container_ul().children('.jstree-initial-node').remove();this.redraw(true);}if(this._data.core.selected.length !== s){this.trigger('changed',{'action':'model','selected':this._data.core.selected});}cb.call(this,true);}, /**
			 ...
			 * @trigger model.jstree, changed.jstree
			 */_append_json_data:function _append_json_data(dom,data,cb,force_processing){dom = this.get_node(dom);dom.children = [];dom.children_d = []; // *%$@!!!
	...
	for(i = 0,j = s.length;i < j;i++) {if($.inArray(s[i],r) === -1){m[s[i]].state.selected = true;}}}}if(_rslt.add.length){this._data.core.selected = this._data.core.selected.concat(_rslt.add);}this.trigger('model',{"nodes":_rslt.dpc,'parent':_rslt.par});if(_rslt.par !== '#'){this._node_changed(_rslt.par);this.redraw();}else { // this.get_container_ul().children('.jstree-initial-node').remove();
	...
	this._redraw();}, /**
			 ...
			 */draw_children:function draw_children(node){var obj=this.get_node(node),i=false,j=false,k=false,d=document;if(!obj){return false;}if(obj.id === '#'){return this.redraw(true);}node = this.get_node(node,true);if(!node || !node.length){return false;} // TODO: quick toggle
	...
	if(!is_callback){par = obj.parent !== '#'?$('#' + obj.parent.replace($.jstree.idregex,'\\$&'),this.element)[0]:null;if(par !== null && (!par || !m[obj.parent].state.opened)){return false;}ind = $.inArray(obj.id,par === null?m['#'].children:m[obj.parent].children);}}else {node = $(node);if(!is_callback){par = node.parent().parent()[0];if(par === this.element[0]){par = null;}ind = node.index();} // m[obj.id].data = node.data(); // use only node's data, no need to touch jquery storage
	...
	if(!par){par = this.element[0];}for(i = 0,j = par.childNodes.length;i < j;i++) {if(par.childNodes[i] && par.childNodes[i].className && par.childNodes[i].className.indexOf('jstree-children') !== -1){tmp = par.childNodes[i];break;}}if(!tmp){tmp = d.createElement('UL');tmp.setAttribute('role','group');tmp.className = 'jstree-children';par.appendChild(tmp);}par = tmp;if(ind < par.childNodes.length){par.insertBefore(node,par.childNodes[ind]);}else {par.appendChild(node);}if(f){t = this.element[0].scrollTop;l = this.element[0].scrollLeft;node.childNodes[1].focus();this.element[0].scrollTop = t;this.element[0].scrollLeft = l;}}if(obj.state.opened && !obj.state.loaded){obj.state.opened = false;setTimeout($.proxy(function(){this.open_node(obj.id,false,0);},this),0);}return node;}, /**
			 ...
			 * @private
			 */_open_to:function _open_to(obj){obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}var i,j,p=obj.parents;for(i = 0,j = p.length;i < j;i += 1) {if(i !== '#'){this.open_node(p[i],false,0);}}return $('#' + obj.id.replace($.jstree.idregex,'\\$&'),this.element);}, /**
			 ...
			 */close_all:function close_all(obj,animation){if(!obj){obj = '#';}obj = this.get_node(obj);if(!obj){return false;}var dom=obj.id === '#'?this.get_container_ul():this.get_node(obj,true),_this=this,i,j;if(!dom.length){for(i = 0,j = obj.children_d.length;i < j;i++) {this._model.data[obj.children_d[i]].state.opened = false;}return this.trigger('close_all',{"node":obj});}dom = this.is_open(obj)?dom.find('.jstree-open').addBack():dom.find('.jstree-open');$(dom.get().reverse()).each(function(){_this.close_node(this,animation || 0);}); /**
			 ...
			 */activate_node:function activate_node(obj,e){if(this.is_disabled(obj)){return false;} // ensure last_clicked is still in the DOM, make it fresh (maybe it was moved?) and make sure it is still selected, if not - make last_clicked the last selected node
	...
	if(p[i] === o){c = !c;}if(p[i] === l){c = !c;}if(c || p[i] === o || p[i] === l){this.select_node(p[i],true,false,e);}else {this.deselect_node(p[i],true,e);}}this.trigger('changed',{'action':'select_node','node':this.get_node(obj),'selected':this._data.core.selected,'event':e});}else {if(!this.is_selected(obj)){this.select_node(obj,false,false,e);}else {this.deselect_node(obj,false,e);}}} /**
			 ...
			 */select_all:function select_all(supress_event){var tmp=this._data.core.selected.concat([]),i,j;this._data.core.selected = this._model.data['#'].children_d.concat();for(i = 0,j = this._data.core.selected.length;i < j;i++) {if(this._model.data[this._data.core.selected[i]]){this._model.data[this._data.core.selected[i]].state.selected = true;}}this.redraw(true); /**
			 ...
			 * @param  {mixed}  obj
			 * @return {Boolean}
			 */is_selected:function is_selected(obj){obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}return obj.state.selected;}, /**
			 ...
			 */refresh_node:function refresh_node(obj){obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}var opened=[],to_load=[],s=this._data.core.selected.concat([]);to_load.push(obj.id);if(obj.state.opened === true){opened.push(obj.id);}this.get_node(obj,true).find('.jstree-open').each(function(){opened.push(this.id);});this._load_nodes(to_load,$.proxy(function(nodes){this.open_node(opened,false,0);this.select_node(this._data.core.selected); /**
			 ...
			 * @return {Boolean}
			 */set_id:function set_id(obj,id){obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}var i,j,m=this._model.data;id = id.toString(); // update parents (replace current ID with new one in children and children_d)
	...
	i = this.get_node(obj.id,true);if(i){i.attr('id',id).children('.jstree-anchor').attr('id',id + '_anchor').end().attr('aria-labelledby',id + '_anchor');if(this.element.attr('aria-activedescendant') === obj.id){this.element.attr('aria-activedescendant',id);}}delete m[obj.id];obj.id = id;obj.li_attr.id = id;m[id] = obj;return true;}, /**
			 ...
			 * @param  {mixed} obj the node
			 * @return {String}
			 */get_text:function get_text(obj){obj = this.get_node(obj);return !obj || obj.id === '#'?false:obj.text;}, /**
			 ...
			 */set_text:function set_text(obj,val){var t1,t2;if($.isArray(obj)){obj = obj.slice();for(t1 = 0,t2 = obj.length;t1 < t2;t1++) {this.set_text(obj[t1],val);}return true;}obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}obj.text = val;if(this.get_node(obj,true).length){this.redraw_node(obj.id);} /**
			 ...
			 * @return {Object}
			 */get_json:function get_json(obj,options,flat){obj = this.get_node(obj || '#');if(!obj){return false;}if(options && options.flat && !flat){flat = [];}var tmp={'id':obj.id,'text':obj.text,'icon':this.get_icon(obj),'li_attr':$.extend(true,{},obj.li_attr),'a_attr':$.extend(true,{},obj.a_attr),'state':{},'data':options && options.no_data?false:$.extend(true,{},obj.data) //( this.get_node(obj, true).length ? this.get_node(obj, true).data() : obj.data ),
	},i,j;if(options && options.flat){tmp.parent = obj.parent;}else {tmp.children = [];}if(!options || !options.no_state){for(i in obj.state) {if(obj.state.hasOwnProperty(i)){tmp.state[i] = obj.state[i];}}}if(options && options.no_id){delete tmp.id;if(tmp.li_attr && tmp.li_attr.id){delete tmp.li_attr.id;}if(tmp.a_attr && tmp.a_attr.id){delete tmp.a_attr.id;}}if(options && options.flat && obj.id !== '#'){flat.push(tmp);}if(!options || !options.no_children){for(i = 0,j = obj.children.length;i < j;i++) {if(options && options.flat){this.get_json(obj.children[i],options,flat);}else {tmp.children.push(this.get_json(obj.children[i],options));}}}return options && options.flat?flat:obj.id === '#'?tmp.children:tmp;}, /**
	...
	/**
			 ...
			 */delete_node:function delete_node(obj){var t1,t2,par,pos,tmp,i,j,k,l,c;if($.isArray(obj)){obj = obj.slice();for(t1 = 0,t2 = obj.length;t1 < t2;t1++) {this.delete_node(obj[t1]);}return true;}obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}par = this.get_node(obj.parent);pos = $.inArray(obj.id,par.children);c = false;if(!this.check("delete_node",obj,par,pos)){this.settings.core.error.call(this,this._data.core.last_error);return false;}if(pos !== -1){par.children = $.vakata.array_remove(par.children,pos);}tmp = obj.children_d.concat([]);tmp.push(obj.id);for(k = 0,l = tmp.length;k < l;k++) {for(i = 0,j = obj.parents.length;i < j;i++) {pos = $.inArray(tmp[k],this._model.data[obj.parents[i]].children_d);if(pos !== -1){this._model.data[obj.parents[i]].children_d = $.vakata.array_remove(this._model.data[obj.parents[i]].children_d,pos);}}if(this._model.data[tmp[k]].state.selected){c = true;pos = $.inArray(tmp[k],this._data.core.selected);if(pos !== -1){this._data.core.selected = $.vakata.array_remove(this._data.core.selected,pos);}}} /**
				 ...
				 * @param {Object} node
				 * @param {String} parent the parent's ID
				 */this.trigger('delete_node',{"node":obj,"parent":par.id});if(c){this.trigger('changed',{'action':'delete_node','node':obj,'selected':this._data.core.selected,'parent':par.id});}for(k = 0,l = tmp.length;k < l;k++) {delete this._model.data[tmp[k]];}this.redraw_node(par,true);return true;}, /**
	...
	tmp = tmp.concat();for(i = 0,j = obj.children_d.length;i < j;i++) {this._model.data[obj.children_d[i]].parents = this._model.data[obj.children_d[i]].parents.slice(0,p * -1);Array.prototype.push.apply(this._model.data[obj.children_d[i]].parents,tmp);}if(old_par === '#' || new_par.id === '#'){this._model.force_full_redraw = true;}if(!this._model.force_full_redraw){this._node_changed(old_par);this._node_changed(new_par.id);}if(!skip_redraw){this.redraw();}}if(callback){callback.call(this,obj,new_par,pos);} /**
	...
	for(i = 0,j = new_par.parents.length;i < j;i++) {this._model.data[new_par.parents[i]].children_d = this._model.data[new_par.parents[i]].children_d.concat(dpc);}dpc = [];for(i = 0,j = new_par.children.length;i < j;i++) {dpc[i >= pos?i + 1:i] = new_par.children[i];}dpc[pos] = tmp.id;new_par.children = dpc;new_par.children_d.push(tmp.id);new_par.children_d = new_par.children_d.concat(tmp.children_d);if(new_par.id === '#'){this._model.force_full_redraw = true;}if(!this._model.force_full_redraw){this._node_changed(new_par.id);}if(!skip_redraw){this.redraw(new_par.id === '#');}if(callback){callback.call(this,tmp,new_par,pos);} /**
			 ...
			 * @trigger cut.jstree
			 */cut:function cut(obj){if(!obj){obj = this._data.core.selected.concat();}if(!$.isArray(obj)){obj = [obj];}if(!obj.length){return false;}var tmp=[],o,t1,t2;for(t1 = 0,t2 = obj.length;t1 < t2;t1++) {o = this.get_node(obj[t1]);if(o && o.id && o.id !== '#'){tmp.push(o);}}if(!tmp.length){return false;}ccp_node = tmp;ccp_inst = this;ccp_mode = 'move_node'; /**
			 ...
			 * @param  {mixed} obj multiple objects can be passed using an array
			 * @trigger copy.jstree
			 */copy:function copy(obj){if(!obj){obj = this._data.core.selected.concat();}if(!$.isArray(obj)){obj = [obj];}if(!obj.length){return false;}var tmp=[],o,t1,t2;for(t1 = 0,t2 = obj.length;t1 < t2;t1++) {o = this.get_node(obj[t1]);if(o && o.id && o.id !== '#'){tmp.push(o);}}if(!tmp.length){return false;}ccp_node = tmp;ccp_inst = this;ccp_mode = 'copy_node'; /**
	...
	"css":{"padding":"0","border":"1px solid silver","box-sizing":"border-box","display":"inline-block","height":this._data.core.li_height + "px","lineHeight":this._data.core.li_height + "px","width":"150px" // will be set a bit further down
	},"blur":$.proxy(function(){var i=s.children(".jstree-rename-input"),v=i.val();if(v === ""){v = t;}h1.remove();s.replaceWith(a);s.remove();this.set_text(obj,t);if(this.rename_node(obj,$('<div></div>').text(v)[this.settings.core.force_text?'text':'html']()) === false){this.set_text(obj,t); // move this up? and fix #483
			 ...
			 * @param {mixed} obj
			 * @return {String}
			 */get_icon:function get_icon(obj){obj = this.get_node(obj);return !obj || obj.id === '#'?false:obj.icon;}, /**
	...
	if(s.indexOf('up') !== -1){while(par && par.id !== '#') {c = 0;for(i = 0,j = par.children.length;i < j;i++) {c += m[par.children[i]].state[t?'selected':'checked'];}if(c === j){par.state[t?'selected':'checked'] = true;this._data[t?'core':'checkbox'].selected.push(par.id);tmp = this.get_node(par,true);if(tmp && tmp.length){tmp.attr('aria-selected',true).children('.jstree-anchor').addClass(t?'jstree-clicked':'jstree-checked');}}else {break;}par = this.get_node(par.parent);}} // apply down (process .children separately?)
	if(s.indexOf('down') !== -1 && dom.length){dom.find('.jstree-anchor').addClass(t?'jstree-clicked':'jstree-checked').parent().attr('aria-selected',true);}},this)).on(this.settings.checkbox.tie_selection?'deselect_all.jstree':'uncheck_all.jstree',$.proxy(function(e,data){var obj=this.get_node('#'),m=this._model.data,i,j,tmp;for(i = 0,j = obj.children_d.length;i < j;i++) {tmp = m[obj.children_d[i]];if(tmp && tmp.original && tmp.original.state && tmp.original.state.undetermined){tmp.original.state.undetermined = false;}}},this)).on(this.settings.checkbox.tie_selection?'deselect_node.jstree':'uncheck_node.jstree',$.proxy(function(e,data){var obj=data.node,dom=this.get_node(obj,true),i,j,tmp,s=this.settings.checkbox.cascade,t=this.settings.checkbox.tie_selection;if(obj && obj.original && obj.original.state && obj.original.state.undetermined){obj.original.state.undetermined = false;} // apply down
	...
	this.element.find('.jstree-closed').not(':has(.jstree-children)').each(function(){var tmp=tt.get_node(this),tmp2;if(!tmp.state.loaded){if(tmp.original && tmp.original.state && tmp.original.state.undetermined && tmp.original.state.undetermined === true){if(o[tmp.id] === undefined && tmp.id !== '#'){o[tmp.id] = true;p.push(tmp.id);}for(k = 0,l = tmp.parents.length;k < l;k++) {if(o[tmp.parents[k]] === undefined && tmp.parents[k] !== '#'){o[tmp.parents[k]] = true;p.push(tmp.parents[k]);}}}}else {for(i = 0,j = tmp.children_d.length;i < j;i++) {tmp2 = m[tmp.children_d[i]];if(!tmp2.state.loaded && tmp2.original && tmp2.original.state && tmp2.original.state.undetermined && tmp2.original.state.undetermined === true){if(o[tmp2.id] === undefined && tmp2.id !== '#'){o[tmp2.id] = true;p.push(tmp2.id);}for(k = 0,l = tmp2.parents.length;k < l;k++) {if(o[tmp2.parents[k]] === undefined && tmp2.parents[k] !== '#'){o[tmp2.parents[k]] = true;p.push(tmp2.parents[k]);}}}}}});this.element.find('.jstree-undetermined').removeClass('jstree-undetermined');for(i = 0,j = p.length;i < j;i++) {if(!m[p[i]].state[t?'selected':'checked']){s = this.get_node(p[i],true);if(s && s.length){s.children('.jstree-anchor').children('.jstree-checkbox').addClass('jstree-undetermined');}}}};this.redraw_node = function(obj,deep,is_callback,force_render){obj = parent.redraw_node.apply(this,arguments);if(obj){var i,j,tmp=null;for(i = 0,j = obj.childNodes.length;i < j;i++) {if(obj.childNodes[i] && obj.childNodes[i].className && obj.childNodes[i].className.indexOf("jstree-anchor") !== -1){tmp = obj.childNodes[i];break;}}if(tmp){if(!this.settings.checkbox.tie_selection && this._model.data[obj.id].state.checked){tmp.className += ' jstree-checked';}tmp.insertBefore(_i.cloneNode(false),tmp.childNodes[0]);}}if(!is_callback && this.settings.checkbox.cascade.indexOf('undetermined') !== -1){if(this._data.checkbox.uto){clearTimeout(this._data.checkbox.uto);}this._data.checkbox.uto = setTimeout($.proxy(this._undetermined,this),50);}return obj;}; /**
			 ...
			 * @plugin checkbox
			 */this.check_all = function(){if(this.settings.checkbox.tie_selection){return this.select_all();}var tmp=this._data.checkbox.selected.concat([]),i,j;this._data.checkbox.selected = this._model.data['#'].children_d.concat();for(i = 0,j = this._data.checkbox.selected.length;i < j;i++) {if(this._model.data[this._data.checkbox.selected[i]]){this._model.data[this._data.checkbox.selected[i]].state.checked = true;}}this.redraw(true); /**
			 ...
			 * @return {Boolean}
			 * @plugin checkbox
			 */this.is_checked = function(obj){if(this.settings.checkbox.tie_selection){return this.is_selected(obj);}obj = this.get_node(obj);if(!obj || obj.id === '#'){return false;}return obj.state.checked;}; /**
	...
	$(document).on('dnd_start.vakata.jstree',function(e,data){lastmv = false;if(!data || !data.data || !data.data.jstree){return;}marker.appendTo('body'); //.show();
	...
	if(data.event.target.id && data.event.target.id === 'jstree-marker'){return;}var ins=$.jstree.reference(data.event.target),ref=false,off=false,rel=false,tmp,l,t,h,p,i,o,ok,t1,t2,op,ps,pr,ip,tm; // if we are over an instance
	 ...
	 */ /**
		 ...
		 */$.jstree.defaults.search = { /**
			 ...
			 */this.clear_search = function(){this._data.search.dom.children(".jstree-anchor").removeClass("jstree-search");if(this.settings.search.close_opened_onclear){this.close_node(this._data.search.opn,0);} /**
				 * triggered after search is complete
				 * @event
				 ...
				 * @plugin search
				 */this.trigger('clear_search',{'nodes':this._data.search.dom,str:this._data.search.str,res:this._data.search.res});this._data.search.str = "";this._data.search.res = [];this._data.search.opn = [];this._data.search.dom = $();}; /**
			 * opens nodes that need to be opened to reveal the search results. Used only internally.
			 * @private
			 * @name _search_open(d)
			 * @param {Array} d an array of node IDs
			 * @plugin search
			 */this._search_open = function(d){var t=this;$.each(d.concat([]),function(i,v){if(v === "#"){return true;}try{v = $('#' + v.replace($.jstree.idregex,'\\$&'),t.element);}catch(ignore) {}if(v && v.length){if(t.is_closed(v)){t._data.search.opn.push(v[0].id);t.open_node(v,function(){t._search_open(d);},0);}}});};}; // helpers
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function (a, b) {
	  ...
	  var c = [],
	    ...
	    return this.length;
	  }, n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(/*! !webpack amd options */ 16) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function (t) {
	  "use strict";function e() {}function i(t) {
	    if (!t || "object" != typeof t) return !1;var e = b(t) || ue;return (/object|function/.test(typeof e.Element) ? t instanceof e.Element : 1 === t.nodeType && "string" == typeof t.nodeName
	    );
	  }function r(t) {
	    ...
	    t.page.x = i.page.x - e.page.x, t.page.y = i.page.y - e.page.y, t.client.x = i.client.x - e.client.x, t.client.y = i.client.y - e.client.y, t.timeStamp = new Date().getTime() - e.timeStamp;var r = Math.max(t.timeStamp / 1e3, .001);t.page.speed = Se(t.page.x, t.page.y) / r, t.page.vx = t.page.x / r, t.page.vy = t.page.y / r, t.client.speed = Se(t.client.x, t.page.y) / r, t.client.vx = t.client.x / r, t.client.vy = t.client.y / r;
	  }function m(t, e, i) {
	    ...
	    if (r(t)) return t;var e = t.ownerDocument || t;return e.defaultView || e.parentWindow || ue;
	  }function w(t) {
	    ...
	    if (!e) return !1;var i = e.options.drag.axis;return "xy" === t || "xy" === i || i === t;
	  }function N(t, e) {
	    ...
	    for (var r = t.options, s = r[i.name].max, n = r[i.name].maxPerElement, o = 0, a = 0, h = 0, p = 0, l = ze.length; l > p; p++) {
	      var c = ze[p],
	        ...
	        if ((o++, o >= ke)) return !1;if (c.target === t) {
	          if ((a += d === i.name | 0, a >= s)) return !1;if (c.element === e && (h++, d !== i.name || h >= n)) return !1;
	        }
	      }
	    }return ke > 0;
	  }function V(t) {
	    ...
	    var r,
	      ...
	      r = ze[s];var h = i;if (r.inertiaStatus.active && r.target.options[r.prepared.name].inertia.allowResume && r.mouse === o) for (; h;) {
	        if (h === r.element) return (r.pointers[0] && r.removePointer(r.pointers[0]), r.addPointer(t), r);h = k(h);
	      }
	    }if (o || !Oe && !_e) {
	      for (s = 0; n > s; s++) if (ze[s].mouse && !ze[s].inertiaStatus.active) return ze[s];for (s = 0; n > s; s++) if (ze[s].mouse && (!/down/.test(e) || !ze[s].inertiaStatus.active)) return r;return (r = new $(), r.mouse = !0, r);
	    }for (s = 0; n > s; s++) if (he(ze[s].pointerIds, a)) return ze[s];if (/up|end|out/i.test(e)) return null;for (s = 0; n > s; s++) if ((r = ze[s], !(r.prepared.name && !r.target.options.gesture.enabled || r.interacting() || !o && r.mouse))) return (r.addPointer(t), r);return new $();
	  }function L(t) {
	    return function (e) {
	      var i,
	          r,
	    ...
	    var o,
	      ...
	      var w = this[g] - t.prevEvent[g],
	          ...
	          z = this.dt / 1e3;this.speed = Se(w, D) / z, this.velocityX = w / z, this.velocityY = D / z;
	    ...
	    if (!e) return !1;if (e === !0) {
	      var a = h(o.width) ? o.width : o.right - o.left,
	          p = h(o.height) ? o.height : o.bottom - o.top;if ((0 > a && ("left" === t ? t = "right" : "right" === t && (t = "left")), 0 > p && ("top" === t ? t = "bottom" : "bottom" === t && (t = "top")), "left" === t)) return r.x < (a >= 0 ? o.left : o.right) + Ae;if ("top" === t) return r.y < (p >= 0 ? o.top : o.bottom) + Ae;if ("right" === t) return r.x > (a >= 0 ? o.right : o.left) - Ae;if ("bottom" === t) return r.y > (p >= 0 ? o.bottom : o.top) - Ae;
	    ...
	    var r,
	        ...
	        l = this.options;if (!s) return null;if (Re.resize && l.resize.enabled) {
	    ...
	    if (!o(t)) return null;var i = t.name,
	    ...
	    for (var i = 0, r = t.length; r > i; i++) if (t[i] === e) return i;return -1;
	  }function he(t, e) {
	    return -1 !== ae(t, e);
	  }function pe(e, i, r) {
	    ...
	    for (; i(t);) {
	      if (pe(t, e)) return !0;if ((t = k(t), t === r)) return pe(t, e);
	    }return !1;
	  }var ce,
	      de,
	      ue = (function () {
	    ...
	    function t(t, e, a, d) {
	      ...
	      function n(t, e, i) {
	        ...
	        if (p === this.element && Z(this.target.getAction(t, this, this.element), this.target).name === this.prepared.name) return ($e(this.inertiaStatus.i), this.inertiaStatus.active = !1, void this.collectEventTargets(t, e, r, "down"));p = k(p);
	      }if (this.interacting()) return void this.collectEventTargets(t, e, r, "down");for (this.setEventXY(this.curCoords, t); i(p) && !o;) this.matches = [], this.matchElements = [], De.forEachSelector(n), o = this.validateSelector(t, this.matches, this.matchElements), p = k(p);return o ? (this.prepared.name = o.name, this.prepared.axis = o.axis, this.prepared.edges = o.edges, this.collectEventTargets(t, e, r, "down"), this.pointerDown(t, e, r, s, o)) : (this.downTimes[l] = new Date().getTime(), this.downTargets[l] = r, this.downEvent = e, d(this.downPointer, t), u(this.prevCoords, this.curCoords), this.pointerWasMoved = !1, void this.collectEventTargets(t, e, r, "down"));
	    }, pointerDown: function pointerDown(t, e, i, r, s) {
	      if (!s && !this.inertiaStatus.active && this.pointerWasMoved && this.prepared.name) return void this.checkAndPreventDefault(e, this.target, this.element);this.pointerIsDown = !0;var n,
	      ...
	      this.recordPointer(t), this.setEventXY(this.curCoords, t instanceof B ? this.inertiaStatus.startEvent : void 0);var o,
	        ...
	        if (h && this.pointerWasMoved && !n) return void this.checkAndPreventDefault(e, this.target, this.element);if ((v(this.pointerDelta, this.prevCoords, this.curCoords), this.prepared.name)) {
	          if (this.pointerWasMoved && (!this.inertiaStatus.active || t instanceof B && /inertiastart/.test(t.type))) {
	              ...
	              var l = Math.abs(o),
	                ...
	                this.prepared.name = null;for (var m = r; i(m);) {
	                  ...
	                  var y = function y(t, e, i) {
	                    var s = de ? i.querySelectorAll(e) : void 0;if (t !== this.target) return I(t, r) && !t.options.drag.manualStart && !R(t, m, r) && F(t, m, r) && pe(m, e, s) && "drag" === t.getAction(this.downPointer, this, m).name && q(g, t) && U(t, m, "drag") ? t : void 0;
	                  };for (m = r; i(m);) {
	            ...
	            }var S = !!this.prepared.name && !this.interacting();if (S && (this.target.options[this.prepared.name].manualStart || !U(this.target, this.element, this.prepared))) return void this.stop();if (this.prepared.name && this.target) {
	      ...
	      for (var r = 0, s = e.length; s > r; r++) {
	        var n = e[r],
	            o = i[r],
	            a = Z(n.getAction(t, this, o), n);if (a && U(n, o, a)) return (this.target = n, this.element = o, a);
	      }
	      ...
	      if (e = e || this.target) {
	        var r = e.options,
	          ...
	          if (/down|start/i.test(t.type) && "drag" === this.prepared.name && "xy" !== r.drag.axis) return;if (r[this.prepared.name] && r[this.prepared.name].manualStart && !this.interacting()) return;return void t.preventDefault();
	      ...
	      var e = this.target.options[this.prepared.name].inertia,
	          i = e.resistance,
	          r = -Math.log(e.endSpeed / t.v0) / i;t.x0 = this.prevEvent.pageX, t.y0 = this.prevEvent.pageY, t.t0 = t.startEvent.timeStamp / 1e3, t.sx = t.sy = 0, t.modifiedXe = t.xe = (t.vx0 - r) / i, t.modifiedYe = t.ye = (t.vy0 - r) / i, t.te = r, t.lambda_v0 = i / t.v0, t.one_ve_v0 = 1 - e.endSpeed / t.v0;
	    ...
	    for (var e = 0; e < this.length; e++) {
	      ...
	      var n = !1;if (!(s = s || this.getRect(r))) return this.options.dropChecker ? this.options.dropChecker(t, n, this, r, e, i) : !1;var o = this.options.drop.overlap;if ("pointer" === o) {
	        var a,
	            p,
	            l = f(t),
	      ...
	      if (!o(t)) return this.setOptions("restrict", t);for (var e, i = ["drag", "resize", "gesture"], r = 0; r < i.length; r++) {
	        var s = i[r];if (s in t) {
	      ...
	      if (!t || !t.type || !he(qe, t.type)) return this;var e,
	          i,
	          r,
	          s = "on" + t.type,
	      ...
	      var r;if ((l(t) && -1 !== t.search(" ") && (t = t.trim().split(/ +/)), n(t))) {
	        ...
	        var p = Ce[t],
	            c = !1;if (!p) return this;for (h = p.selectors.length - 1; h >= 0; h--) if (p.selectors[h] === this.selector && p.contexts[h] === this._context) {
...
/* 18 */
/*!**********************************************!*\
  !*** ./src/src/modules/fileManager/index.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _FileManager = __webpack_require__(/*! ./FileManager */ 19);
	
	var _FileManager2 = _interopRequireDefault(_FileManager);
	
	var Module = {
		activate: function activate(loaded) {
			var fileManager = new _FileManager2["default"]();
...
/* 19 */
/*!****************************************************!*\
  !*** ./src/src/modules/fileManager/FileManager.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Request = __webpack_require__(/*! ./Request */ 20);
...
/* 20 */
/*!************************************************!*\
  !*** ./src/src/modules/fileManager/Request.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _libAureliaHttpClient = __webpack_require__(/*! ../../../../lib/aurelia-http-client */ 21);
	...
	var Request = (function (_HttpClient) {
		...
		return Request;
	})(_libAureliaHttpClient.HttpClient);
...
/* 21 */
/*!******************************************!*\
  !*** ./lib/aurelia-http-client/index.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _httpClient = __webpack_require__(/*! ./http-client */ 22);
	...
	var _httpRequestMessage = __webpack_require__(/*! ./http-request-message */ 26);
	...
	var _httpResponseMessage = __webpack_require__(/*! ./http-response-message */ 28);
	...
	var _jsonpRequestMessage = __webpack_require__(/*! ./jsonp-request-message */ 30);
	...
	var _headers = __webpack_require__(/*! ./headers */ 23);
	...
	var _requestBuilder = __webpack_require__(/*! ./request-builder */ 24);
...
/* 22 */
/*!************************************************!*\
  !*** ./lib/aurelia-http-client/http-client.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 23 */
/*!********************************************!*\
  !*** ./lib/aurelia-http-client/headers.js ***!
  \********************************************/
/***/ function(module, exports) {
...
/* 24 */
/*!****************************************************!*\
  !*** ./lib/aurelia-http-client/request-builder.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _aureliaPath = __webpack_require__(/*! ../aurelia-path */ 25);
...
/* 26 */
/*!*********************************************************!*\
  !*** ./lib/aurelia-http-client/http-request-message.js ***!
  \*********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _requestMessageProcessor = __webpack_require__(/*! ./request-message-processor */ 27);
	
	var _transformers = __webpack_require__(/*! ./transformers */ 29);
...
/* 27 */
/*!**************************************************************!*\
  !*** ./lib/aurelia-http-client/request-message-processor.js ***!
  \**************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 28 */
/*!**********************************************************!*\
  !*** ./lib/aurelia-http-client/http-response-message.js ***!
  \**********************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 29 */
/*!*************************************************!*\
  !*** ./lib/aurelia-http-client/transformers.js ***!
  \*************************************************/
/***/ function(module, exports) {
...
/* 30 */
/*!**********************************************************!*\
  !*** ./lib/aurelia-http-client/jsonp-request-message.js ***!
  \**********************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 31 */
/*!******************************************!*\
  !*** ./src/src/modules/plugins/index.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _PluginsManager = __webpack_require__(/*! ./PluginsManager */ 32);
	
	var _PluginsManager2 = _interopRequireDefault(_PluginsManager);
	
	var Module = {
		activate: function activate(loaded) {
			var plugins = new _PluginsManager2["default"]();
			IDE.plugins = plugins;
...
/* 32 */
/*!***************************************************!*\
  !*** ./src/src/modules/plugins/PluginsManager.js ***!
  \***************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var PluginsManager = (function () {
	   ...
	   */
	    ...
	    */
			...
			key: "registerPluginToolbarElements",
			value: function registerPluginToolbarElements(pluginName) {
				...
				toolbarElements.forEach(function (element) {
					...
					_this2.toolbarElements.push(element);
				});
			}
		}, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./style.css */ 35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./style.css */ 36);
	...
	if(true) {
		...
		if(!content.locals) {
			module.hot.accept(/*! !./../../../~/css-loader!./style.css */ 36, function() {
				var newContent = __webpack_require__(/*! !./../../../~/css-loader!./style.css */ 36);
...
/* 36 */
/*!******************************************************!*\
  !*** ./~/css-loader!./src/plugins/history/style.css ***!
  \******************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".page-toolbar-item-undo-enabled  {\n\tbackground-image: url(" + __webpack_require__(/*! ./images/undo.png */ 38) + ");\n}\n\n.page-toolbar-item-undo {\n\tbackground-image: url(" + __webpack_require__(/*! ./images/undo_disabled.png */ 39) + ");\n}\n\n.page-toolbar-item-redo-enabled {\n\tbackground-image: url(" + __webpack_require__(/*! ./images/redo.png */ 40) + ");\n}\n\n.page-toolbar-item-redo{\n\tbackground-image: url(" + __webpack_require__(/*! ./images/redo_disabled.png */ 41) + ");\n}", ""]);
...
/* 38 */
/*!*********************************************!*\
  !*** ./src/plugins/history/images/undo.png ***!
  \*********************************************/
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 39 */
/*!******************************************************!*\
  !*** ./src/plugins/history/images/undo_disabled.png ***!
  \******************************************************/
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 40 */
/*!*********************************************!*\
  !*** ./src/plugins/history/images/redo.png ***!
  \*********************************************/
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 41 */
/*!******************************************************!*\
  !*** ./src/plugins/history/images/redo_disabled.png ***!
  \******************************************************/
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./style.css */ 45);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../../~/style-loader/addStyles.js */ 42)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(true) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept(/*! !./../../../~/css-loader!./style.css */ 45, function() {
				var newContent = __webpack_require__(/*! !./../../../~/css-loader!./style.css */ 45);
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 45 */
/*!***************************************************!*\
  !*** ./~/css-loader!./src/plugins/save/style.css ***!
  \***************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".page-toolbar-item-save {\n\tbackground-image: url(" + __webpack_require__(/*! ./images/save_disabled.png */ 46) + ");\n}\n\n.page-toolbar-item-save-enabled {\n    background-image: url(" + __webpack_require__(/*! ./images/save.png */ 47) + ");\n}", ""]);
...
/* 46 */
/*!***************************************************!*\
  !*** ./src/plugins/save/images/save_disabled.png ***!
  \***************************************************/
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 47 */
/*!******************************************!*\
  !*** ./src/plugins/save/images/save.png ***!
  \******************************************/
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/* 49 */
/*!*****************************************!*\
  !*** ./src/plugins/history/manifest.js ***!
  \*****************************************/
/***/ function(module, exports) {
...
/* 51 */
/*!******************************************!*\
  !*** ./src/src/modules/qParams/index.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 53 */
/*!*********************************************!*\
  !*** ./src/src/modules/tabManager/index.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabManager = __webpack_require__(/*! ./TabManager */ 54);
	
	var _TabManager2 = _interopRequireDefault(_TabManager);
	
	var Module = {
		activate: function activate(loaded) {
			IDE.tabs = _TabManager2['default'];
			IDE.tabs.list = {};
	
			_TabManager2['default'].connect(IDE.qParams.path);
	
			_TabManager2['default'].on('close', function () {
				_TabManager2['default'].close();
				_TabManager2['default'].connect();
			});
	
			_TabManager2['default'].on('join', function (id) {
				IDE.tabs.list[id] = true;
			});
	
			_TabManager2['default'].on('leave', function (id) {
...
/* 54 */
/*!**************************************************!*\
  !*** ./src/src/modules/tabManager/TabManager.js ***!
  \**************************************************/
/***/ function(module, exports) {
...
/* 55 */
/*!******************************************!*\
  !*** ./src/src/modules/toolbar/index.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Toolbar = __webpack_require__(/*! ./Toolbar */ 56);
...
/* 56 */
/*!********************************************!*\
  !*** ./src/src/modules/toolbar/Toolbar.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Toolbar = (function () {
		...
		_createClass(Toolbar, [{
			...
			value: function swapItemClass(item, oldClass, newClass) {
				...
				container.className = (0, _Utils.safeClassReplace)(container.className, oldClass, newClass);
			}
		}, {
			key: "addClassToItem",
			...
			key: "removeClassToItem",
			value: function removeClassToItem(item, targetClass) {
				var container = this.getItemContainer(item);
				targetClass = this.itemPrefix + targetClass;
				container.className = (0, _Utils.safeClassReplace)(container.className, targetClass, "");
			}
		}, {
			key: "editItemClasses",
			value: function editItemClasses(item, options) {
				...
				toRemove.forEach(function (item) {
					_this2.removeClassToItem(container, item);
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./common.css */ 58);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 42)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(true) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept(/*! !./../../~/css-loader!./common.css */ 58, function() {
				var newContent = __webpack_require__(/*! !./../../~/css-loader!./common.css */ 58);
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 58 */
/*!**********************************************!*\
  !*** ./~/css-loader!./src/styles/common.css ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./editor.css */ 60);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 42)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(true) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept(/*! !./../../~/css-loader!./editor.css */ 60, function() {
				var newContent = __webpack_require__(/*! !./../../~/css-loader!./editor.css */ 60);
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 60 */
/*!**********************************************!*\
  !*** ./~/css-loader!./src/styles/editor.css ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./tree.css */ 62);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 42)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(true) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept(/*! !./../../~/css-loader!./tree.css */ 62, function() {
				var newContent = __webpack_require__(/*! !./../../~/css-loader!./tree.css */ 62);
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 62 */
/*!********************************************!*\
  !*** ./~/css-loader!./src/styles/tree.css ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".cloud-ide-tree-ext-home {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/home.png */ 63) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-waperm {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/permissions.png */ 64) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-waproject {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/project.png */ 65) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-wadirectory {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/directory.png */ 66) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-wasolution{\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/solution.png */ 67) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-wasettings {\n\t/*background-image: url(\"../images/tree/settings.png\") !important;*/\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-wamodel {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/catalog.png */ 68) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-folder {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/folder-closed.png */ 69) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-css {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/css.png */ 70) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-html {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/html.png */ 71) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-js {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/javascript.png */ 72) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-json {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/json.png */ 73) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}\n\n.cloud-ide-tree-ext-unknown {\n\tbackground-image: url(" + __webpack_require__(/*! ../images/tree/unknown.png */ 74) + ") !important;\n\tbackground-size: 16px 16px;\n\tbackground-position: 4px 4px !important;\n}", ""]);
...
/* 64 */
/*!*****************************************!*\
  !*** ./src/images/tree/permissions.png ***!
  \*****************************************/
/***/ function(module, exports) {
...
/* 69 */
/*!*******************************************!*\
  !*** ./src/images/tree/folder-closed.png ***!
  \*******************************************/
/***/ function(module, exports) {
...
/* 72 */
/*!****************************************!*\
  !*** ./src/images/tree/javascript.png ***!
  \****************************************/
/***/ function(module, exports) {
