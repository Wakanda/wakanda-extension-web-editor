...
/* 7 */
/*!******************************************!*\
  !*** ./src/src/modules/editor/Editor.js ***!
  \******************************************/
	...
	var Editor = (function () {
	  ...
	  */
			...
			value: function ready() {
				...
				setTimeout(function () {
					return _this2.events.emit("editor.onready", { name: "editor.onready" });
				}, 0);
			}
		}, {
			key: "create",
...
/* 10 */
/*!*********************************************!*\
  !*** ./src/src/modules/editor/EditorCSS.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _Editor2 = __webpack_require__(/*! ./Editor */ 7);
	
	var _Editor3 = _interopRequireDefault(_Editor2);
	
	var EditorHTML = (function (_Editor) {
		_inherits(EditorHTML, _Editor);
	
		function EditorHTML() {
			_classCallCheck(this, EditorHTML);
	
			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}
	
			_get(Object.getPrototypeOf(EditorHTML.prototype), "constructor", this).apply(this, args);
		...
		_createClass(EditorHTML, [{
			key: "initMode",
			value: function initMode() {
				__webpack_require__(/*! ../../../../lib/ace-min-noconflict/ext-language_tools.js */ 8);
				__webpack_require__(/*! ../../../../lib/ace-min-noconflict/ext-emmet.js */ 9);
				this.setOptions({
					enableEmmet: true,
...
//# sourceMappingURL=2.2.build.js.map