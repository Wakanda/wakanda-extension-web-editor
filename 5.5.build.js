...
/***/ 67:
/*!******************************************!*\
  !*** ./src/modules/editor/EditorHTML.js ***!
  \******************************************/
		...
		_createClass(EditorHTML, {
			initMode: {
				value: function initMode() {
					__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../lib/ace-min-noconflict/ext-emmet.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
					this.setOptions({
						enableEmmet: true
					});
				}
...
//# sourceMappingURL=5.5.build.js.map